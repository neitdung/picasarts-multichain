        ...
        <Box>
            <SimpleGrid columns={2} p={20} gap={20}>
                <Box p={5} borderRadius={10} bgColor={metadata?.background_color ? metadata.background_color : 'gray.200'} h={'min'}>
                    {(metadata?.image) ? <Image borderRadius={10} src={`https://fs.picasarts.io/btfs/${metadata.image}`} w={'full'} /> : <Skeleton w={'full'} minH={500} />}
                </Box>
                ...
                <SimpleGrid columns={2} gap={10} px={10}>
                    <Box>
                        ...
                        <Flex align={'center'} gap={5}>
                            <Avatar size={'sm'} name='Avatar Creator' src={creatorData?.avatar ? `https://fs.picasarts.io/btfs/${creatorData?.avatar}` : ""} />
                    ...
                    {collectionData && <Box>
                        ...
                        <Flex align={'center'} gap={5}>
                            <Avatar size={'sm'} name='Collection Name' src={collectionData.logo ? `https://fs.picasarts.io/btfs/${collectionData.logo}` : ""} />
